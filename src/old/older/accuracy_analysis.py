...
utt_length = coding_sh.col_values(10) #utterance length

segment_accuracy = coding_sh.col_values(8)
tone_accuracy = coding_sh.col_values(9)
...
for r in range(1,n_rows):
    ...
    if participant != coding_sh.cell_value(r,0):
        if not first:
            #print 'TONE DICTIONARY tone 4: ', Dt_tone4['1syl_ISO']
            #print 'SEGMENT DICTIONARY tone 4: ', Ds_tone4['1syl_ISO']
